...
import openstack_dashboard.dashboards.fogbow.federated_network.tabs as tabsFederatedNetworkDashboard
...
FOGBOW_USER_DATA = 'org.fogbowcloud.request.user-data'
